    ...
    <>
      ...
      {!loading && (
        ...
        >
          ...
          <div className="ruled-lines fixed inset-0 pointer-events-none opacity-40 z-0" aria-hidden />

          {/* ---- HERO / INTRO ---- */}
          <section className="relative z-10 mx-auto max-w-5xl px-6 pt-20 pb-16 md:pt-32 md:pb-24">
            {/* Top line decoration */}
            <motion.div
              className="mb-12 h-px bg-[#111]"
              initial={{ width: 0 }}
              animate={{ width: "100%" }}
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-[#111] leading-[1.1]">
                <span className="block">Two sides.</span>
                <span className="block mt-1">One person.</span>
              </h1>
              <p className="mt-6 max-w-lg text-base md:text-lg text-[#666] leading-relaxed">
            ...
            {/* Decorative line */}
            <motion.div
              className="mt-12 h-px bg-[#c0c0b8]"
              initial={{ width: 0 }}
              animate={{ width: "60%" }}
          ...
          <section className="relative z-10 mx-auto max-w-5xl px-6 pb-20">
            <motion.p
              className="font-mono text-xs tracking-widest uppercase text-[#999] mb-8"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 1 }}
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              ...
              <motion.div
                ...
                whileHover={{ rotate: 0, y: -4, boxShadow: "4px 4px 0px #c0c0b8" }}
                ...
                <Link href={exitSide ? "#" : "/nerdy"} onClick={() => setExitSide("nerdy")} data-hover>
                  <div className="paper-card relative p-8 md:p-10 tape-top overflow-hidden min-h-[280px] flex flex-col justify-between">
                    ...
                    <div
                      ...
                      style={{
                        borderRadius: "50%",
                        background: "radial-gradient(ellipse, transparent 40%, rgba(100,95,88,0.08) 50%, transparent 62%)",
                      }}
                    />

                    <div>
                      <div className="flex items-center gap-3 mb-4">
                        <div className="flex h-10 w-10 items-center justify-center border border-[#c0c0b8]">
                          <Terminal className="h-5 w-5 text-[#111]" />
                        </div>
                        <span className="font-mono text-xs text-[#999]">{">_"}</span>
                      </div>
                    ...
                    <div className="mt-8 flex items-center gap-2 text-sm font-mono text-[#999] group-hover:text-[#111] transition-colors">
                      <span>explore</span>
                      <motion.span
                    ...
                    <div className="absolute bottom-0 left-0 h-[3px] w-0 bg-[#111] group-hover:w-full transition-all duration-500" />
                  </div>
                </Link>
              </motion.div>
                ...
                <Link href={exitSide ? "#" : "/creative"} onClick={() => setExitSide("creative")} data-hover>
                  <div className="paper-card relative p-8 md:p-10 tape-top overflow-hidden min-h-[280px] flex flex-col justify-between">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-4">
                        <div className="flex h-10 w-10 items-center justify-center border border-[#c0c0b8]">
                          <Pen className="h-5 w-5 text-[#111]" />
                        </div>
          ...
          <section className="relative z-10 mx-auto max-w-5xl px-6 pb-20">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <div className="border-t border-[#c0c0b8] pt-12">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div className="relative h-6 w-6">
                    <div
                      className="absolute inset-0 border border-[#c0c0b8]"
                      style={{
                        borderRadius: "50%",
                    ...
                    >
                      <div
                        className="absolute top-1/2 left-1/2 h-2 w-2 -translate-x-1/2 -translate-y-1/2 bg-[#111]"
                  ...
                  <div className="flex gap-4" style={{ minWidth: "max-content" }}>
                    {tracks.map((track, i) => (
                      ...
                      >
                        ...
                        <div className="mb-3 aspect-square w-full border border-[#c0c0b8] bg-[#eaeae4] flex items-center justify-center">
                          <div className="h-8 w-8 border border-[#c0c0b8]" style={{ borderRadius: "50%" }}>
                            <div className="h-full w-full flex items-center justify-center">
                              <div className="h-2 w-2 bg-[#111]" style={{ borderRadius: "50%" }} />
                            </div>
                          </div>
                        </div>
                        <p className="text-sm font-bold text-[#111] truncate">{track.title}</p>
                        <p className="text-xs text-[#999] truncate mt-0.5">{track.artist}</p>
                        <p className="text-xs text-[#ccc] truncate mt-0.5 font-mono">{track.album}</p>
                      </motion.div>
                    ))}
                  </div>
                </div>
          ...
          <section className="relative z-10 mx-auto max-w-5xl px-6 pb-16">
            <motion.div
              className="border-t border-[#c0c0b8] pt-12"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, margin: "-60px" }}
              transition={{ duration: 0.6 }}
            >
              <p className="font-mono text-xs tracking-widest uppercase text-[#999] mb-8">
                find me elsewhere
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {socials.map((s, i) => (
                  <motion.a
                    ...
                    className="paper-card flex items-center gap-3 px-5 py-3 text-sm text-[#666] hover:text-[#111] transition-colors"
                    data-hover
                    initial={{ opacity: 0, y: 12 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.1, duration: 0.4 }}
                    whileHover={{ y: -2, boxShadow: "3px 3px 0px #c0c0b8" }}
          ...
          <footer className="relative z-10 border-t border-[#c0c0b8]">
            <div className="mx-auto max-w-5xl px-6 py-8 flex items-center justify-between">
              ...
              <p className="font-mono text-xs text-[#ccc]">
